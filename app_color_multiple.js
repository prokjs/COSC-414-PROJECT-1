...
var InitDemo = function() {
	...
	var angleStart = Math.round(Math.random() * 2 * 3.1419592 * 100) / 100;
	//The random color of the bacteria
	var colorStart = [0.1+Math.random(),0.1+Math.random(),0.1+Math.random()];
	...
	var tick = function() {
		...
		createCircle(sectionSize,angleStart,1,360,0.9,colorStart);	
